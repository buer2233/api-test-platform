...
PRIVATE_ENV_ENABLED = os.getenv("ENABLE_PRIVATE_API_TESTS") == "1"
REQUIRES_PRIVATE_ENV = pytest.mark.skipif(
    not PRIVATE_ENV_ENABLED,
    reason="需要私有环境、真实账号和有效 RSA 公钥；默认不纳入本地回归",
)
